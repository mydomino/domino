  ...
  render(){
    return(
      <div>
        ...
        <div className="bg-white rounded-top h2 medium white pt2 line-height-3 black">{ (this.props.method == "POST") ? "-" : this.state.cf } kg <div className="h4 mt0">Carbon Emissions</div>
        </div>
      </div>
    );
  }
